...
class TemplateClass{
    ...
    mayor_party(info){
      return `<h2>`+info["body"]["Constituency"]+`</h2>
          <div class="row-wrap"> 
            <div>जिल्ला</div>
            <div>`+info["body"].DistrictName+`</div>
          </div>
          <div class="row-wrap">
            <div>प्रदेश</div>
            <div>`+ProvinceNepaliName[info["body"].StateID]+`</div>
          </div>
          <div class="row-wrap">
            <div>`+"बिजेता"+`</div>
            <div>
    ...
    mayor_age(info){
      return `<h2>`+info["body"]["Constituency"]+`</h2>
          ...
          `<div class="row-wrap">
            <div>उमेर</div>
            <div>
              `+ toNepaliDigits(info["body"]["1stAge"]) + " वर्ष" + " (उमेर समूह: " + toNepaliDigits(info["body"]["1stAgeBracket"]) + "   वर्ष)" +`
            </div>
          </div>`
          + (info["body"].unopposed ? 
            `<div class="text-center" style="margin:10px">`+info["body"].unopposed+`</div>` 
            ...
            `<div class="row-wrap">
              <div>उमेर</div>
              <div>
                `+ toNepaliDigits(info["body"]["2ndAge"]) + " वर्ष" + " (उमेर समूह: " + toNepaliDigits(info["body"]["2ndAgeBracket"]) + "   वर्ष)" +`
              </div>
            </div>`
